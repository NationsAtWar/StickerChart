...
public class SubCommand extends StickerChartCommandExecutor {
 
	public SubCommand(StickerChart stickerChart) {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		plugin.getDatasource().subtract(player.getName(), displayName, amount);
		
		plugin.sendMessage(sender, ChatColor.GREEN + "Subtracted " + amount + " reputation from " + args[0]);
